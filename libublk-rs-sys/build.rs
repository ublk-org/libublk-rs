...
MARK_FIX_753(UBLK_U_CMD_UPDATE_SIZE);
MARK_FIX_753(UBLK_U_CMD_QUIESCE_DEV);
MARK_FIX_753(UBLK_U_CMD_TRY_STOP_DEV);
MARK_FIX_753(UBLK_U_CMD_REG_BUF);
MARK_FIX_753(UBLK_U_CMD_UNREG_BUF);
MARK_FIX_753(UBLK_U_IO_REGISTER_IO_BUF);
MARK_FIX_753(UBLK_U_IO_UNREGISTER_IO_BUF);
MARK_FIX_753(UBLK_U_IO_PREP_IO_CMDS);
MARK_FIX_753(UBLK_U_IO_COMMIT_IO_CMDS);
MARK_FIX_753(UBLK_U_IO_FETCH_IO_CMDS);
